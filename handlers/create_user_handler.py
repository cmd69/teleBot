...
async def random_value(call: types.CallbackQuery):
    ...
    # Always prompt the user for their username
    ...
    async def get_username(message: types.Message):
        ...
        if call.data == "new_user":
            dbManager.create_new_user(chatID, username, False)
        elif call.data == "new_demo":
            dbManager.create_new_user(chatID, username, True)
